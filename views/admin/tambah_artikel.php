            ...
            <div class="container px-5">
                ...
                <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                    <div class="text-center mb-5">
                        ...
                        <h1 class="fw-bolder">Tambah Artikel</h1>
                        <!-- <p class="lead fw-normal text-muted mb-0">add text here</p> -->
                    </div>
                    <div class="row gx-5 justify-content-center">
                        <form id="keluhanForm" method="post" action="./tambah_artikel_process" role="form" enctype="multipart/form-data">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="judul_artikel" name="judul_artikel" type="text" placeholder="Enter your title here..." required />
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <textarea id="deskripsi_artikel" name="deskripsi_artikel"></textarea>

...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/ml0hfu6yx3smx7cvgv347z9r9ovbm1yu1y238p9lruoljak9/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>

        
        <script>
             tinymce.init({
               selector: 'textarea#deskripsi_artikel', });
        </script>
</head>
<style>
